...
function UIElements.CreateFrame(SkillTree)
    return Instance.new("Frame", game.Players.LocalPlayer.PlayerGui) {
...
function UIElements.CreateTitleLabel(SkillTree, parent)
    return Instance.new("TextLabel", parent) {
        Name = "SkillTreeTitle",
...
function UIElements.CreateButton(SkillTree, parent, text, onClick)
    return Instance.new("TextButton", parent) {
        Name = text .. "Button",
        ...
        TextSize = 14,
        [Instance.new("BindableEvent", script).Event] = onClick
    }
end
